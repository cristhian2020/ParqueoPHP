                    ...
                    <div class="col-md-6">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Llene toda la información</h3>
                                    ...
                                    <div class="row">
                                        <div class=col-md-12>
                                            <div class="form group">
                                                        ...
                                                        <textarea name="" id="obs" cols="15" rows="7" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <button class="btn btn-success btn-block" id="btn_registrar"> Registrar</button>
                                            </div>
                                        </div>
                                        <div id="respuesta">
                            </div>
...
<script>
    $('#btn_registrar').click(function () {
        ...
        if(nro_espacio == "" ){
            alert('Debe de llenar el campo espacio');
            $('#nro_espacio').focus();
